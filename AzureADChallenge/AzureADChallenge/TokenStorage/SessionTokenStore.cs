...
namespace AzureADChallenge.TokenStorage
{
    ...
    public class SessionTokenStore
    {
        ...
        public bool HasData()
        {
            var result = httpContext.Session[tokenCacheKey] != null && byte[] httpContext.Session[tokenCacheKey].Length > 0;
            return result;
        }
        ...
        private void BeforeAccessNotification(TokenCacheNotificationArgs args)
        {
            ...
            try
            {
                ...
                args.TokenCache.DeserializeMsalV3(msalV3State: (byte[])httpContext.Session[tokenCacheKey]);
            }
            finally
            {
